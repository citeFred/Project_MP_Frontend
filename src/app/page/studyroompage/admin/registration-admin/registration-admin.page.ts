        ...
        try {
            ...
            if (response?.data) {
                ...
                this.CourseRegistrationResponseData[courseId] = courseRegistrations.map(registration => {
                    ...
                    return {
                        course_registration_id: registration.course_registration_id, // 필수 속성
                        course_registration_status: registration.course_registration_status, // 필수 속성
                        course_reporting_date: new Date(registration.course_reporting_date), // 필수 속성
                        user: user
                            ? {
